...
Aspiring DevOps Engineer based in Udaipur, India, currently working as DevOps Engineer at SparkEighteen. Passionate about streamlining workflows, embracing cloud-native technologies, and building resilient, scalable infrastructure that empowers development teams to deliver faster and more reliably.

I am a results-driven DevOps Engineer with a passion for automating infrastructure, scaling cloud-native applications, and optimizing CI/CD workflows. With hands-on experience across AWS, Azure, Kubernetes, Docker, and Terraform. Having completed my B.Tech in Computer Science and Engineering in May 2025 with a CGPA of 9.40, I have gained practical experience through real-world projects, certifications (RHCSA), and continuous learning in competitive programming and system design.
