...
const Ansible = ({ width = 35, height = 45 }) => {
  return (
    <>
      <svg
        width={width}
...
const DBeaver = ({ width = 35, height = 45 }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
const Grafana = ({ width = 35, height = 45 }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
const Serverless = ({ width = 35, height = 45 }) => {
  return (
    <>
      <svg
        width={width}
...
const Bitbucket = ({ width = 40, height = 40 }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
const Jenkins = ({ width = 35, height = 35 }) => {
  return (
    <>
      <svg
        xmlns="http://www.w3.org/2000/svg"
...
const Airflow = ({ width = 35, height = 35 }) => {
  return (
    <svg
      width={width}
      height={height}
    ...
    >
      ...
      <g>
        <path
          d="M128 0L256 128L128 256L0 128L128 0Z"
          fill="url(#airflow-gradient-1)"
        ...
        <circle
          ...
          cy="128"
          r="64"
          fill="url(#airflow-gradient-2)"
        />
        <path
          d="M128 64L192 128L128 192L64 128L128 64Z"
          fill="url(#airflow-gradient-3)"
        />
        <circle
          cx="128"
          cy="128"
          r="32"
          fill="url(#airflow-gradient-4)"
        />
        <text
          x="128"
          y="138"
